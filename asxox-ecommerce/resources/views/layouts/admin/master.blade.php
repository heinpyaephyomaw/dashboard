...
<head>
   ...
   <!-- font awesome-->
    ...
    <!-- feather icon -->
    <link rel="stylesheet" type="text/css" href="{{url('files\assets\icon\feather-icon-2\feather.css')}}">
    <!-- Style.css -->
    <link rel="stylesheet" type="text/css" href="{{url('files\assets\css\style.css')}}">
    <link rel="stylesheet" type="text/css" href="{{url('files\assets\css\extra.css')}}">
...
<div id="pcoded" class="pcoded">
    ...
    <script type="text/javascript" src="{{url('files\assets\js\extra.js')}}"></script>
